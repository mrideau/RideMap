...
/* harmony import */ var _carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./carousel */ "./resources/js/carousel.js");
...
var Carousel = /*#__PURE__*/function () {
  function Carousel(carousel) {
    ...
    _defineProperty(this, "dotsContainer", null);

    _defineProperty(this, "dots", []);

    _defineProperty(this, "lastIndex", null);

    _defineProperty(this, "currIndex", 0);
  ...
  _createClass(Carousel, [{
    key: "calculIndex",
    value: function calculIndex(index) {
...
carousels.forEach(function (carousel) {
  var car = new Carousel(carousel); // setInterval(() => {
  //     car.next();
  // }, 2000);
});
...
var headerTopOffset = header.offsetTop;
